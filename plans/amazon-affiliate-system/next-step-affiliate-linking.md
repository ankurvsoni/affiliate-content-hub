...
2. Build `affiliate-links-v1.csv`
3. Inject links into the 10 draft articles
4. Add backup ASIN per primary pick
5. Add link-health check step (stock + 404 checks)
